...
import { createBook, BookFormData } from '../../api/bookApi';
...
const AddBook: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.error || 'Failed to create book';
    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center mb-6">
          <Book className="h-8 w-8 text-[var(--primary)] mr-3" />
